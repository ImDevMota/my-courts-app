        ...
        <div className="container mx-auto max-w-4xl">
          <div className="mb-8">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Conecte-se com outros jogadores, reserve horários e confirme sua presença nas melhores quadras de basquete da cidade.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-card/50">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Por que escolher a MyCourts?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="shadow-card-shadow border-border bg-card text-center">
              ...
              <CardContent>
                <CardDescription>
                  Descubra as melhores quadras da sua região com informações detalhadas sobre localização e horários disponíveis.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-card-shadow border-border bg-card text-center">
              ...
              <CardContent>
                <CardDescription>
                  Veja quantos jogadores já confirmaram presença e garanta que terá um jogo animado com o time completo.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-card-shadow border-border bg-card text-center">
              ...
              <CardContent>
                <CardDescription>
                  Confirme sua presença com um clique e mantenha seus jogos organizados em um só lugar.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Navegue pelas quadras disponíveis e veja todas as informações importantes.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Selecione o horário e confirme sua participação com um simples clique.
                  </p>
                </div>
              </div>
      ...
      <section className="py-16 px-4 bg-card/50">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-muted-foreground text-lg mb-8">
            Junte-se à comunidade MyCourts e nunca mais perca um jogo por falta de jogadores.
          </p>
          <Link to="/cadastro">
            <Button 
              size="lg"
